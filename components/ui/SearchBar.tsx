...
const SearchBar = () => {
    return (
        <div
            className="bg-light-item-bg dark:bg-dark-item-bg border-light-item-border dark:border-dark-item-border border-[1px] rounded flex mb-4 focus-within:outline focus-within:outline-4 focus-within:outline-light-blue">
            <div className="m-1">
